...
import (
	...
	envoy_config_core_v3 "envoy/config/core/v3"
)
...
var (
	...
	_ = envoy_config_core_v3.envoy / config / core / v3 / config_source.proto_ApiVersion(0)
)
...
func (m *CommonGrpcAccessLogConfig) validate(all bool) error {
	...
	if _, ok := envoy_config_core_v3.ApiVersion_name[int32(m.GetTransportApiVersion())]; !ok {
		err := CommonGrpcAccessLogConfigValidationError{
